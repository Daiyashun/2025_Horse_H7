...
void fdcan1_rx_callback(void)
{
    ...
    for (int i = 0; i < 4; i++)
    {
        if (i == id - 1 - 16)
        {
            ...
            case MASTER_M3_ID:
                motor[2].receive.pos /= GEAR_RATIO;
                motor[2].receive.speed /= GEAR_RATIO;
...
void fdcan2_rx_callback(void)
{
    ...
    for (int i = 4; i < 8; i++)
    {
        if (i == id - 1 - 16)
        {
            ...
            case MASTER_M6_ID:
                motor[5].receive.pos /= GEAR_RATIO;
                motor[5].receive.speed /= GEAR_RATIO;
...
void fdcan3_rx_callback(void)
{
    ...
    for (int i = 8; i < 12; i++)
    {
        if (i == id - 1 - 16)
        {
            ...
            {
            case MASTER_M9_ID:
                motor[8].receive.pos /= GEAR_RATIO;
                motor[8].receive.speed /= GEAR_RATIO;
            ...
            case MASTER_M12_ID:
                motor[11].receive.pos /= GEAR_RATIO;
                motor[11].receive.speed /= GEAR_RATIO;
