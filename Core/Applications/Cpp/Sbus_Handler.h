...
public:
    ...
    int Sbus_Visual_Walk_Mode_Change_Flag;
...
#define SBUS_Visual_Walk_Flag 10
#define SBUS_Visual_WalkObstacle_Flag 100
#define SBUS_Visual_WalkGrovel_Flag 1000
...
#define SBUS_Visual_WalkMode_Choose_SC Sbus_Channel[7 - 1]
...
#define SBUS_Jump_START_FLAG_SF Sbus_Channel[10 - 1]
    ...
    int Sbus_Visual_Walk_Mode_Choose(float Sbus_Channel);
